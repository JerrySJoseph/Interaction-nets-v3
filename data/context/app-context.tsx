...
import Node, { generateNewNode } from "../models/node";
...
export const AppContextProvider = ({ children }: AppContextProviderProps) => {
    ...
    useEffect(() => {
        ...
        setLinks([link1,link2,link3,link4]);
        additionNode.links.push(link1,link2);
        multiplicationNode.links.push(link3,link4);
    ...
    function onNodeMoved(newPosX:number,newPosY:number,nodeId:string){
        ...
        newInet.nodes=inet.nodes.map(n=>n.id===nodeId?{...n,x:newPosX,y:newPosY}:n)
